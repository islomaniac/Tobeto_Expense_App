          ...
          children: [
            ...
            IconButton(
                ...
                onPressed: () async {
                  ...
                  DateTime? selected =
                      await showDatePicker(context: context, initialDate: now, firstDate: year, lastDate: now);
                  setState(() {
                    if (selected == null) {
            ...
            ElevatedButton(
                onPressed: () {
                  // ignore: avoid_print
                  print("Kaydedilen değer: ${_expenseNameController.text} ${_expensePriceControler.text}, $dateText");
                },
